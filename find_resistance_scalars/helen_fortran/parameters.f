...
*----------------------------------------------------------------------*
*
      real*8 A(1:2,1:Nspheres,1:3+Nspheres,1:Nmax,-Nmax:Nmax), 
     +     B(1:2,1:Nspheres,1:3+Nspheres,1:Nmax,-Nmax:Nmax), 
     +     C(1:2,1:Nspheres,1:3+Nspheres,1:Nmax,-Nmax:Nmax),
     +     D(1:2,1:Nspheres,1:3+Nspheres,1:Nmax,-Nmax:Nmax), 
     +     E(1:2,1:Nspheres,1:3+Nspheres,1:Nmax,-Nmax:Nmax), 
     +     F(1:2,1:Nspheres,1:3+Nspheres,1:Nmax,-Nmax:Nmax)
